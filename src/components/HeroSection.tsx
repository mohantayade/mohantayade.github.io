...
<div className="absolute w-full bottom-0 inset-x-0 md:h-40 h-5 bg-gradient-to-b pointer-events-none select-none from-transparent dark:to-black to-white z-20 " />
        <div className="absolute w-full -bottom-[120px] sm:-bottom-40 h-[400px] md:h-full z-10 ">
